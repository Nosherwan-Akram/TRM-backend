...
class Model: 
	...
	def setupRNN(self):
		...
		numHidden = 256
		#cells = [MultiDimensionalLSTMCell(num_units=numHidden) for _ in range(2)] # 2 layers
	...
	def setupCTC(self):
		...
		if self.decoderType == DecoderType.BestPath:
			...
			wordChars = open('HTR/model/wordCharList.txt').read().splitlines()[0]
	...
	def save(self):
		"save model to file"
		self.snapID += 1
		self.saver.save(self.sess, 'HTR/model/snapshot', global_step=self.snapID)
